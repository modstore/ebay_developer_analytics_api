...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => '\Modstore\EbayDeveloperAnalyticsApi\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \Modstore\EbayDeveloperAnalyticsApi\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \Modstore\EbayDeveloperAnalyticsApi\Model\ErrorParameter[]|null $parameters An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned.
     *
     * @return self
     */
