...
class RateLimit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'api_name' => 'string',
        'api_version' => 'string',
        'resources' => '\Modstore\EbayDeveloperAnalyticsApi\Model\Resource[]'
    ];
     ...
     * Gets resources
     *
     * @return \Modstore\EbayDeveloperAnalyticsApi\Model\Resource[]|null
     */
     ...
     * Sets resources
     *
     * @param \Modstore\EbayDeveloperAnalyticsApi\Model\Resource[]|null $resources A list of the methods for which rate-limit data is returned. For example <code>item</code> for the Feed API, <code>getOrder</code> for the Fulfillment API, <code>getProduct</code> for the Catalog API, <code>AddItems</code> for the Trading API.
     *
     * @return self
     */
