...
class Resource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'rates' => '\Modstore\EbayDeveloperAnalyticsApi\Model\Rate[]'
    ];
     ...
     * Gets rates
     *
     * @return \Modstore\EbayDeveloperAnalyticsApi\Model\Rate[]|null
     */
     ...
     * Sets rates
     *
     * @param \Modstore\EbayDeveloperAnalyticsApi\Model\Rate[]|null $rates A list of rate-limit data, where each list element represents the rate-limit data for a specific resource.
     *
     * @return self
     */
